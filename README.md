...
The project is a fork from [nimo-markdown-sv](https://github.com/wodeni/nimo-markdown-cv) which provides an alternative styling theme for [markdown-cv](http://elipapa.github.io/markdown-cv).
